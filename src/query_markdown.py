...
def get_similar_markdown_docs(jira_ticket_description: str, k: int = 8):
    dotenv.load_dotenv()
    ...
    retriever = vectorstore.as_retriever(search_type="mmr", search_kwargs={"k": k, "fetch_k": 20, "score_threshold": 0.6})
